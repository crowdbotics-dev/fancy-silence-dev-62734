"""
Django settings for fancy_silence_dev_62734 project.
...
ROOT_URLCONF = 'fancy_silence_dev_62734.urls'
...
WSGI_APPLICATION = 'fancy_silence_dev_62734.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_silence_dev_62734 API",
    "DESCRIPTION": "API documentation for fancy_silence_dev_62734 App",
    "VERSION": "v1",
}
